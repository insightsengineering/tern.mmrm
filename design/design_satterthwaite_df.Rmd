...
Coefficient Estimates can be obtained with:
...
The `contrast()` function in `emmeans` can be used to compute any linear functions
...
as in SAS, can specify the required linear combinations:
