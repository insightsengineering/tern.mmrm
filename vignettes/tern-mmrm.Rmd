...
Note that currently many options available in SAS are not available in `tern.mmrm`, e.g. AR(1) where $(\mathbf V_i)_{jk} = \sigma^2 \rho^{|j-k|}$ or Toeplitz where $(\mathbf V_i)_{jk}=\theta_{|j-k|}$.
